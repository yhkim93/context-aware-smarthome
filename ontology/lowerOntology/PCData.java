...
/**
 *  Java class for concept PC of SmartHouseOntology ontology.
 */
public abstract class PCData	extends ComputingDevice implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this PC.
	...
	/**
	 * Persist this PC using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1292593533*name.charAt(0))>>>15)%4;
}
