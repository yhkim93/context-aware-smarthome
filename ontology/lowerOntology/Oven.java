 ...
 * This class implements the functionality of Oven.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Oven</code> of SmartHouseOntology ontology.
 */
public class Oven  extends OvenData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public Oven(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>Oven</code>.
  ...
  /** 
   *  Get a clone of this <code>Oven</code>.
  ...
  /** 
   *  Test the equality of this <code>Oven</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Oven</code> class,
