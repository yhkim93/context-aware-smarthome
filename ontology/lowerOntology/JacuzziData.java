...
/**
 *  Java class for concept Jacuzzi of SmartHouseOntology ontology.
 */
public abstract class JacuzziData	extends BodyCare implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this Jacuzzi.
	...
	/**
	 * Persist this Jacuzzi using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1099863719*name.charAt(0))>>>15)%4;
}
