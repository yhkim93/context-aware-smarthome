...
/**
 *  Java class for concept Drinks of SmartHouseOntology ontology.
 */
public abstract class DrinksData	extends Consumable implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this Drinks.
	...
	/**
	 * Persist this Drinks using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1042168907*name.charAt(0))>>>15)%2;
}
