 ...
 * This class implements the functionality of CleaningDevice.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>CleaningDevice</code> of SmartHouseOntology ontology.
 */
public class CleaningDevice  extends CleaningDeviceData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public CleaningDevice(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>CleaningDevice</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public CleaningDevice(CleaningDevice proto) {
  ...
  /**
   *  Get a string representation of this <code>CleaningDevice</code>.
  ...
  /** 
   *  Get a clone of this <code>CleaningDevice</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new CleaningDevice(this);
  }
  
  /** 
   *  Test the equality of this <code>CleaningDevice</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>CleaningDevice</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof CleaningDevice) {
      CleaningDevice cmp=(CleaningDevice)obj;
