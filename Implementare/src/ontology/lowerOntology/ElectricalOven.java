 ...
 * This class implements the functionality of ElectricalOven.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>ElectricalOven</code> of SmartHouseOntology ontology.
 */
public class ElectricalOven  extends ElectricalOvenData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>ElectricalOven</code>.
   */
   ...
   * @param timestamp    
   */
  public ElectricalOven(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>ElectricalOven</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public ElectricalOven(ElectricalOven proto) {
  ...
  /**
   *  Get a string representation of this <code>ElectricalOven</code>.
   *  @return The string representation.
   */
  public String toString() {
    return "ElectricalOven("
  ...
  /** 
   *  Get a clone of this <code>ElectricalOven</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new ElectricalOven(this);
  }
  
  /** 
   *  Test the equality of this <code>ElectricalOven</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>ElectricalOven</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof ElectricalOven) {
      ElectricalOven cmp=(ElectricalOven)obj;
