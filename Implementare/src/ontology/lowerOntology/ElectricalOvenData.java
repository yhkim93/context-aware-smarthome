...
/**
 *  Java class for concept ElectricalOven of SmartHouseOntology ontology.
 */
public abstract class ElectricalOvenData	extends Oven implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this ElectricalOven.
	...
	/**
	 * Persist this ElectricalOven using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1956812754*name.charAt(0))>>>15)%4;
}
