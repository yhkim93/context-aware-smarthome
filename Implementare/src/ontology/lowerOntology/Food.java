 ...
 * This class implements the functionality of Food.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Food</code> of SmartHouseOntology ontology.
 */
public class Food  extends FoodData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param instancename    
   */
  public Food(Location haslocation, String instancename) {
  ...
  /**
   *  Get a string representation of this <code>Food</code>.
  ...
  /** 
   *  Get a clone of this <code>Food</code>.
  ...
  /** 
   *  Test the equality of this <code>Food</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Food</code> class,
