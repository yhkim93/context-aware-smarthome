...
/**
 *  Java class for concept CDPlayer of SmartHouseOntology ontology.
 */
public abstract class CDPlayerData	extends AudioAndVideo implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this CDPlayer.
	...
	/**
	 * Persist this CDPlayer using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((2138394697*name.charAt(0))>>>15)%4;
}
