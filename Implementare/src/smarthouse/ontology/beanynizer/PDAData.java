...
/**
 *  Java class for concept PDA of SmartHouseOntology ontology.
 */
public abstract class PDAData	extends ComputingDevice implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this PDA.
	...
	/**
	 * Persist this PDA using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1338919971*name.charAt(0))>>>15)%4;
}
