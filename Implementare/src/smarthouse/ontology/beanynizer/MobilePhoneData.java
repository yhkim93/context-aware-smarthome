...
/**
 *  Java class for concept MobilePhone of SmartHouseOntology ontology.
 */
public abstract class MobilePhoneData	extends CommunicationDevice implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this MobilePhone.
	...
	/**
	 * Persist this MobilePhone using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((845614248*name.charAt(0))>>>15)%4;
}
