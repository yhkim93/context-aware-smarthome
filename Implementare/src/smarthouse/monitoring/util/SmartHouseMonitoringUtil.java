...
import smarthouse.util.AgentMessage;
import com.hp.hpl.jena.ontology.Individual;
import com.jgoodies.forms.factories.*;
import com.jgoodies.forms.layout.*;

public class SmartHouseMonitoringUtil extends JPanel implements ActionListener {
	...
	public SmartHouseMonitoringUtil(final IExternalAccess agent) {
		this.agent = agent;
		model = new CreateModel(
				"http://www.owl-ontologies.com/Ontology1207603095.owl#",
				"file:smarthouse/ontology/SmartHouse.owl");
		sensors = new Vector();
		devices = new Vector();
	...
	private void initComponents() {
		...
		// ======== panel2 ========
		{
			...
			// ======== panel5 ========
			{
				...
				panel5.setLayout(new FormLayout("default:grow",
						"default, default"));
				// ======== tabbedPane2 ========
				{
					tabbedPane2.setBackground(Color.white);
					tabbedPane2.setBorder(new SoftBevelBorder(
					...
					// ======== panel4 ========
					{
						...
						comboBox8.addItemListener(new ItemListener() {
							...
							public void itemStateChanged(ItemEvent e) {
								if (e.getStateChange() == ItemEvent.SELECTED) {
									setCurrentSensorLocation(comboBox8,
											comboBox9);

									setCurrentSensorValue(comboBox8, comboBox10);
									setCurrentSensorStatus(comboBox8,
											comboBox15);
									setCurrentSensorTimestamp(comboBox8,
											textField1);
								}
							}
						});
						...
						// ======== simpleInternalFrame1 ========
						{
							...
							Container simpleInternalFrame1ContentPane = simpleInternalFrame1
									.getContentPane();
							simpleInternalFrame1ContentPane
									.setLayout(new FormLayout("default",
											"default"));
						}
						panel4.add(simpleInternalFrame1, cc.xywh(1, 1, 11, 15));
					}
					tabbedPane2.addTab("Sensors", new ImageIcon(getClass()
							.getResource("/smarthouse/images/sensor2.png")), panel4);
					// ======== panel7 ========
					{
						...
						panel7.setLayout(new FormLayout(new ColumnSpec[] {
								...
								new RowSpec[] {
										...
										new RowSpec(RowSpec.CENTER, Sizes
												.dluY(63),
												FormSpec.DEFAULT_GROW),
										FormFactory.LINE_GAP_ROWSPEC,
						...
						comboBox12.addItemListener(new ItemListener() {
							public void itemStateChanged(ItemEvent e) {
								if (e.getStateChange() == ItemEvent.SELECTED) {
									setCurrentDeviceLocation(comboBox12,
											comboBox13);
									setCurrentDeviceValue(comboBox12,
											comboBox14);
									setCurrentDeviceTimestamp(comboBox12,
											textField3);
								}
							}
						});
						...
						// ======== simpleInternalFrame2 ========
						{
							...
							Container simpleInternalFrame2ContentPane = simpleInternalFrame2
									.getContentPane();
							simpleInternalFrame2ContentPane
									.setLayout(new FormLayout("default",
											"default"));
						}
					...
					tabbedPane2.addTab("Devices", new ImageIcon(getClass()
							.getResource("/smarthouse/images/device1.png")), panel7);
					// ======== panel6 ========
					{
						...
						// ======== simpleInternalFrame3 ========
						{
							...
							Container simpleInternalFrame3ContentPane = simpleInternalFrame3
									.getContentPane();
							simpleInternalFrame3ContentPane
									.setLayout(new FormLayout("default",
											"default"));
						}
						panel6.add(simpleInternalFrame3, cc.xywh(1, 1, 13, 13));
					}
					tabbedPane2.addTab("Sensor Management", new ImageIcon(
							getClass().getResource("/smarthouse/images/sensor1.png")),
							panel6);
					// ======== panel8 ========
					{
						...
						deviceSubType = model.getSubclasses(comboBox20
						...
						// ======== simpleInternalFrame4 ========
						{
							...
							Container simpleInternalFrame4ContentPane = simpleInternalFrame4
									.getContentPane();
							simpleInternalFrame4ContentPane
									.setLayout(new FormLayout("default",
											"default"));
						}
						panel8.add(simpleInternalFrame4, cc.xywh(1, 1, 13, 23));
					}
					tabbedPane2.addTab("Device Management", new ImageIcon(
							getClass().getResource("/smarthouse/images/device2.png")),
							panel8);
					// ======== panel1 ========
					{
						...
						comboBox1 = ComboUtil.initCombo(comboBox1,
								states, label24);
						comboBox1
								.setSelectedItem(model
										.getIndividualPropertyValue("Mary",
												"hasState"));
						...
						comboBox4.setSelectedItem(model
								.getIndividualPropertyValue("Mary",
										"hasLocation"));
						...
						comboBox6.setSelectedItem(model
								.getIndividualPropertyValue("Mary",
										"hasActivity"));
						...
						comboBox27.setSelectedItem(model
								.getIndividualPropertyValue("LittleJohn",
										"hasLocation"));
						...
						comboBox26.setSelectedItem(model
								.getIndividualPropertyValue("Jane",
										"hasLocation"));
						...
						comboBox2 = ComboUtil.initCombo(comboBox2,
								states, label25);
						comboBox2.addActionListener(this);
						comboBox2
								.setSelectedItem(model
										.getIndividualPropertyValue("John",
												"hasState"));
						...
						comboBox24.setSelectedItem(model
								.getIndividualPropertyValue("John",
										"hasLocation"));
						...
						comboBox28.setSelectedItem(model
								.getIndividualPropertyValue("John",
										"hasActivity"));
						...
						// ---- comboBox3 ----
						comboBox3 = ComboUtil.initCombo(comboBox3,
								states, label26);
						...
						// ---- comboBox5 ----
						comboBox5 = ComboUtil.initCombo(comboBox5,
								states, label31);
						comboBox5.addActionListener(this);
						comboBox5.setSelectedItem(model
								.getIndividualPropertyValue("LittleJohn",
										"hasState"));
						...
						comboBox29.setSelectedItem(model
								.getIndividualPropertyValue("Jane",
										"hasActivity"));
						...
						comboBox30.setSelectedItem(model
								.getIndividualPropertyValue("LittleJohn",
										"hasActivity"));
						...
						// ======== simpleInternalFrame5 ========
						{
							...
							Container simpleInternalFrame5ContentPane = simpleInternalFrame5
									.getContentPane();
					...
					tabbedPane2.addTab("State Detector", new ImageIcon(
							getClass().getResource("/smarthouse/images/emoticon.png")),
							panel1);
				}
			...
			// ======== panel3 ========
			{
				panel3.setBorder(new CompoundBorder(new TitledBorder(
						"Action Log"), new EmptyBorder(5, 5, 5, 5)));
				...
				panel3.add(scrollPane1, new GridBagConstraints(0, 0, 1, 1, 0.0,
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == comboBox7) {
			...
			Vector deviceSubType = new Vector();
			deviceSubType = model.getSubclasses(comboBox20.getSelectedItem()
					.toString());
			;
			...
			ComboUtil.updateLabel(sel, label24);
		}

		else if (e.getSource() == comboBox2) {
			String sel = (String) comboBox2.getSelectedItem();
			ComboUtil.updateLabel(sel, label25);
		} else if (e.getSource() == comboBox3) {
			String sel = (String) comboBox3.getSelectedItem();
			ComboUtil.updateLabel(sel, label26);
		} else if (e.getSource() == comboBox5) {
			String sel = (String) comboBox5.getSelectedItem();
			ComboUtil.updateLabel(sel, label31);
		}
	}

	public void createSensor(String individualClass, String sensorValue,
			String timestamp, String deviceStatus, String instanceName,
			String location) {
		...
		model
				.setPropertyValue(instanceName, "instanceName", instanceName,
						true);
		model
				.setPropertyValue(instanceName, "deviceStatus", deviceStatus,
						true);
		model.setPropertyValue(instanceName, "hasLocation", location, false);
	}

	public void createDevice(String individualClass, String timestamp,
			String deviceStatus, String instanceName, String location) {
		Individual x = model.createIndividual(instanceName, individualClass);
		model.setPropertyValue(instanceName, "timestamp", timestamp, true);
		model
				.setPropertyValue(instanceName, "instanceName", instanceName,
	...
	public Vector getGuiContent(String sensorType) {
		...
		for (int i = 0; i < sensorInd.size(); i++) {
			...
			Location loc = new Location(model.getIndividualPropertyValue(crt,
					"hasLocation"));
			Sensor s = new Sensor(model.getIndividualPropertyValue(crt,
					"deviceStatus"), loc, model.getIndividualPropertyValue(crt,
					"instanceName"), model.getIndividualPropertyValue(crt,
					"sensorValue"), model.getIndividualPropertyValue(crt,
					"timestamp"));
	...
	public Vector getGuiContent2(String deviceType) {
		...
		for (int i = 0; i < sensorInd.size(); i++) {
			...
			Location loc = new Location(model.getIndividualPropertyValue(crt,
					"hasLocation"));
			Device s = new Device(model.getIndividualPropertyValue(crt,
					"deviceStatus"), loc,

			model.getIndividualPropertyValue(crt, "instanceName"), model
					.getIndividualPropertyValue(crt, "timestamp"));
	...
	private class AddSensor extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Individual x = model.createIndividual(individualName,
					individualClass);
			createSensor(individualClass, comboBox18.getSelectedItem()
					.toString(), "124564646", comboBox19.getSelectedItem()
					.toString(), individualName, comboBox17.getSelectedItem()
					.toString());
	...
	private class AddNewDevice extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			Individual x = model.createIndividual(individualName,
					individualClass);
			createDevice(individualClass, "124564646", comboBox23
					.getSelectedItem().toString(), individualName, comboBox21
					.getSelectedItem().toString());
			textArea1.setText(textArea1.getText() + " \n"
	...
	private class SetSensorData extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "sensorValue", comboBox10
					.getSelectedItem().toString(), true);
			model.setPropertyValue(instanceName, "timestamp", "54645564561",
					true);
			model.setPropertyValue(instanceName, "deviceStatus", comboBox15
					.getSelectedItem().toString(), true);
			model.setPropertyValue(instanceName, "hasLocation", comboBox9
					.getSelectedItem().toString(), false);
			textArea1.setText(textArea1.getText() + " \n" + " Set Sensor: "
					+ instanceName + "\n\t Sensor Value: "
					+ comboBox10.getSelectedItem().toString()
					+ "\n \t Sensor Status: "
					+ comboBox15.getSelectedItem().toString()
					+ "\n \t Sensor Location: "
			...
			Sensor sensor = new Sensor(comboBox15.getSelectedItem().toString(),
					...
					instanceName, comboBox9.getSelectedItem().toString(),
			...
			me.getParameterSet(jadex.adapter.fipa.SFipa.RECEIVERS).addValue(
					receiver);
	...
	private class SetDeviceData extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "timestamp", "54645564561",
					true);
			model.setPropertyValue(instanceName, "deviceStatus", comboBox14
					.getSelectedItem().toString(), true);
			model.setPropertyValue(instanceName, "hasLocation", comboBox13
					.getSelectedItem().toString(), false);
			textArea1.setText(textArea1.getText() + " \n" + " Set Sensor: "
					+ instanceName + "\n \t Sensor Status: "
					+ comboBox14.getSelectedItem().toString()
					+ "\n \t Sensor Location: "
					+ comboBox13.getSelectedItem().toString() + "\n \t at "
					+ textField1.getText());
			setCurrentDeviceId(comboBox11, comboBox12);
		}
	}
	...
	private class setMaryState extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "hasState", comboBox1
					.getSelectedItem().toString(), true);
		}
	}
	...
	private class setJohnState extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "hasState", comboBox2
					.getSelectedItem().toString(), true);
		}
	...
	private class setJLittleJohnState extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "hasState", comboBox5
					.getSelectedItem().toString(), true);
		}
	}
	...
	private class setLittleJaneState extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			...
			model.setPropertyValue(instanceName, "hasState", comboBox3
					.getSelectedItem().toString(), true);
		}
	}
}