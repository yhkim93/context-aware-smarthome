 ...
 * This class implements the functionality of Clock.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Clock</code> of SmartHouseOntology ontology.
 */
public class Clock  extends ClockData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public Clock(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>Clock</code>.
  ...
  /** 
   *  Get a clone of this <code>Clock</code>.
  ...
  /** 
   *  Test the equality of this <code>Clock</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Clock</code> class,
