...
/**
 *  Java class for concept BodyCare of SmartHouseOntology ontology.
 */
public abstract class BodyCareData	extends Device implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this BodyCare.
	...
	/**
	 * Persist this BodyCare using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1071290068*name.charAt(0))>>>15)%4;
}
