 ...
 * This class implements the functionality of Motocycle.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Motocycle</code> of SmartHouseOntology ontology.
 */
public class Motocycle  extends MotocycleData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public Motocycle(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>Motocycle</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public Motocycle(Motocycle proto) {
  ...
  /**
   *  Get a string representation of this <code>Motocycle</code>.
  ...
  /** 
   *  Get a clone of this <code>Motocycle</code>.
  ...
  /** 
   *  Test the equality of this <code>Motocycle</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Motocycle</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof Motocycle) {
      Motocycle cmp=(Motocycle)obj;
