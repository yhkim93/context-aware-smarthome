 ...
 * This class implements the functionality of WashingMachine.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>WashingMachine</code> of SmartHouseOntology ontology.
 */
public class WashingMachine  extends WashingMachineData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public WashingMachine(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>WashingMachine</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public WashingMachine(WashingMachine proto) {
  ...
  /**
   *  Get a string representation of this <code>WashingMachine</code>.
  ...
  /** 
   *  Get a clone of this <code>WashingMachine</code>.
  ...
  /** 
   *  Test the equality of this <code>WashingMachine</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>WashingMachine</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof WashingMachine) {
      WashingMachine cmp=(WashingMachine)obj;
