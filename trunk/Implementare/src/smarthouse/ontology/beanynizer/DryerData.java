...
/**
 *  Java class for concept Dryer of SmartHouseOntology ontology.
 */
public abstract class DryerData	extends CleaningDevice implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this Dryer.
	...
	/**
	 * Persist this Dryer using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((1159424724*name.charAt(0))>>>15)%4;
}
