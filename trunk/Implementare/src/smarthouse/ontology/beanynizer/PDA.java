 ...
 * This class implements the functionality of PDA.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>PDA</code> of SmartHouseOntology ontology.
 */
public class PDA  extends PDAData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>PDA</code>.
   */
  public PDA() {
   ...
   * @param timestamp    
   */
  public PDA(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>PDA</code>.
  ...
  /** 
   *  Get a clone of this <code>PDA</code>.
  ...
  /** 
   *  Test the equality of this <code>PDA</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>PDA</code> class,
