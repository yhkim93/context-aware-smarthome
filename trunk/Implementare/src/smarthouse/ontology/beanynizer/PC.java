 ...
 * This class implements the functionality of PC.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>PC</code> of SmartHouseOntology ontology.
 */
public class PC  extends PCData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>PC</code>.
   */
  public PC() {
   ...
   * @param timestamp    
   */
  public PC(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>PC</code>.
  ...
  /** 
   *  Get a clone of this <code>PC</code>.
  ...
  /** 
   *  Test the equality of this <code>PC</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>PC</code> class,
