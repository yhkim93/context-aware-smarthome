 ...
 * This class implements the functionality of Fridge.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Fridge</code> of SmartHouseOntology ontology.
 */
public class Fridge  extends FridgeData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public Fridge(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>Fridge</code>.
  ...
  /** 
   *  Get a clone of this <code>Fridge</code>.
  ...
  /** 
   *  Test the equality of this <code>Fridge</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Fridge</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof Fridge) {
      Fridge cmp=(Fridge)obj;
