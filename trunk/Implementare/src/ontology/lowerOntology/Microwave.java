 ...
 * This class implements the functionality of Microwave.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Microwave</code> of SmartHouseOntology ontology.
 */
public class Microwave  extends MicrowaveData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>Microwave</code>.
   */
  public Microwave() {
   ...
   * @param timestamp    
   */
  public Microwave(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>Microwave</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public Microwave(Microwave proto) {
  ...
  /**
   *  Get a string representation of this <code>Microwave</code>.
  ...
  /** 
   *  Get a clone of this <code>Microwave</code>.
  ...
  /** 
   *  Test the equality of this <code>Microwave</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Microwave</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof Microwave) {
      Microwave cmp=(Microwave)obj;
