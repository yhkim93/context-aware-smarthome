 ...
 * This class implements the functionality of VacuumCleaner.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>VacuumCleaner</code> of SmartHouseOntology ontology.
 */
public class VacuumCleaner  extends VacuumCleanerData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public VacuumCleaner(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>VacuumCleaner</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public VacuumCleaner(VacuumCleaner proto) {
  ...
  /**
   *  Get a string representation of this <code>VacuumCleaner</code>.
  ...
  /** 
   *  Get a clone of this <code>VacuumCleaner</code>.
  ...
  /** 
   *  Test the equality of this <code>VacuumCleaner</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>VacuumCleaner</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof VacuumCleaner) {
      VacuumCleaner cmp=(VacuumCleaner)obj;
