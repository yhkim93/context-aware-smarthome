 ...
 * This class implements the functionality of HouseholdDevice.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>HouseholdDevice</code> of SmartHouseOntology ontology.
 */
public class HouseholdDevice  extends HouseholdDeviceData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public HouseholdDevice(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>HouseholdDevice</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public HouseholdDevice(HouseholdDevice proto) {
  ...
  /**
   *  Get a string representation of this <code>HouseholdDevice</code>.
  ...
  /** 
   *  Get a clone of this <code>HouseholdDevice</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new HouseholdDevice(this);
  }
  
  /** 
   *  Test the equality of this <code>HouseholdDevice</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>HouseholdDevice</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof HouseholdDevice) {
      HouseholdDevice cmp=(HouseholdDevice)obj;
