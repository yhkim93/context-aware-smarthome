 ...
 * This class implements the functionality of DoorBell.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>DoorBell</code> of SmartHouseOntology ontology.
 */
public class DoorBell  extends DoorBellData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public DoorBell(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>DoorBell</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public DoorBell(DoorBell proto) {
  ...
  /**
   *  Get a string representation of this <code>DoorBell</code>.
  ...
  /** 
   *  Get a clone of this <code>DoorBell</code>.
  ...
  /** 
   *  Test the equality of this <code>DoorBell</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>DoorBell</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof DoorBell) {
      DoorBell cmp=(DoorBell)obj;
