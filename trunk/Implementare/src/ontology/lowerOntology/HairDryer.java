 ...
 * This class implements the functionality of HairDryer.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>HairDryer</code> of SmartHouseOntology ontology.
 */
public class HairDryer  extends HairDryerData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public HairDryer(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>HairDryer</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public HairDryer(HairDryer proto) {
  ...
  /**
   *  Get a string representation of this <code>HairDryer</code>.
  ...
  /** 
   *  Get a clone of this <code>HairDryer</code>.
  ...
  /** 
   *  Test the equality of this <code>HairDryer</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>HairDryer</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof HairDryer) {
      HairDryer cmp=(HairDryer)obj;
