 ...
 * This class implements the functionality of EntertainmentDevice.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>EntertainmentDevice</code> of SmartHouseOntology ontology.
 */
public class EntertainmentDevice  extends EntertainmentDeviceData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public EntertainmentDevice(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>EntertainmentDevice</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public EntertainmentDevice(EntertainmentDevice proto) {
  ...
  /**
   *  Get a string representation of this <code>EntertainmentDevice</code>.
  ...
  /** 
   *  Get a clone of this <code>EntertainmentDevice</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new EntertainmentDevice(this);
  }
  
  /** 
   *  Test the equality of this <code>EntertainmentDevice</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>EntertainmentDevice</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof EntertainmentDevice) {
      EntertainmentDevice cmp=(EntertainmentDevice)obj;
