 ...
 * This class implements the functionality of TransportationDevice.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>TransportationDevice</code> of SmartHouseOntology ontology.
 */
public class TransportationDevice  extends TransportationDeviceData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public TransportationDevice(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>TransportationDevice</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public TransportationDevice(TransportationDevice proto) {
  ...
  /**
   *  Get a string representation of this <code>TransportationDevice</code>.
  ...
  /** 
   *  Get a clone of this <code>TransportationDevice</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new TransportationDevice(this);
  }
  
  /** 
   *  Test the equality of this <code>TransportationDevice</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>TransportationDevice</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof TransportationDevice) {
      TransportationDevice cmp=(TransportationDevice)obj;
