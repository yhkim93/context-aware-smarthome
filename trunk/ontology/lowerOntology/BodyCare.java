 ...
 * This class implements the functionality of BodyCare.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>BodyCare</code> of SmartHouseOntology ontology.
 */
public class BodyCare  extends BodyCareData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>BodyCare</code>.
   */
  public BodyCare() {
   ...
   * @param timestamp    
   */
  public BodyCare(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>BodyCare</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public BodyCare(BodyCare proto) {
  ...
  /**
   *  Get a string representation of this <code>BodyCare</code>.
  ...
  /** 
   *  Get a clone of this <code>BodyCare</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new BodyCare(this);
  }
  
  /** 
   *  Test the equality of this <code>BodyCare</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>BodyCare</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof BodyCare) {
      BodyCare cmp=(BodyCare)obj;
