 ...
 * This class implements the functionality of CommunicationDevice.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>CommunicationDevice</code> of SmartHouseOntology ontology.
 */
public class CommunicationDevice  extends CommunicationDeviceData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>CommunicationDevice</code>.
   */
   ...
   * @param timestamp    
   */
  public CommunicationDevice(String devicestatus, Location haslocation, String instancename, String timestamp) {
   ...
   *  Create a new <code>CommunicationDevice</code>.<br>
   *  Copy all attributes from <code>proto</code> to this instance.
   *
   *  @param proto The prototype instance.
   */
  public CommunicationDevice(CommunicationDevice proto) {
  ...
  /**
   *  Get a string representation of this <code>CommunicationDevice</code>.
  ...
  /** 
   *  Get a clone of this <code>CommunicationDevice</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new CommunicationDevice(this);
  }
  
  /** 
   *  Test the equality of this <code>CommunicationDevice</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>CommunicationDevice</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof CommunicationDevice) {
      CommunicationDevice cmp=(CommunicationDevice)obj;
