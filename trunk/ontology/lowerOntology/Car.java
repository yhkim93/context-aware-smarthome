 ...
 * This class implements the functionality of Car.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Car</code> of SmartHouseOntology ontology.
 */
public class Car  extends CarData implements nuggets.INugget
{
  //-------- constructors --------
   ...
   * @param timestamp    
   */
  public Car(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>Car</code>.
  ...
  /** 
   *  Get a clone of this <code>Car</code>.
  ...
  /** 
   *  Test the equality of this <code>Car</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Car</code> class,
