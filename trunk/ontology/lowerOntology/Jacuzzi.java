 ...
 * This class implements the functionality of Jacuzzi.
 * Feel free to change.
 *
 */
...
/**
 *  Editable Java class for concept <code>Jacuzzi</code> of SmartHouseOntology ontology.
 */
public class Jacuzzi  extends JacuzziData implements nuggets.INugget
{
  //-------- constructors --------

  /** 
   *  Default Constructor. <br>
   *  Create a new <code>Jacuzzi</code>.
   */
  public Jacuzzi() {
   ...
   * @param timestamp    
   */
  public Jacuzzi(String devicestatus, Location haslocation, String instancename, String timestamp) {
  ...
  /**
   *  Get a string representation of this <code>Jacuzzi</code>.
  ...
  /** 
   *  Get a clone of this <code>Jacuzzi</code>.
   *  @return a shalow copy of this instance.
   */
  public Object clone() {
    return new Jacuzzi(this);
  }
  
  /** 
   *  Test the equality of this <code>Jacuzzi</code> 
   *  and an object <code>obj</code>.
   *
   *  @param obj the object this test will be performed with
   *  @return false if <code>obj</code> is not of <code>Jacuzzi</code> class,
   *          true if all attributes are equal.   
   */
  public boolean equals(Object obj) {
    if (obj instanceof Jacuzzi) {
      Jacuzzi cmp=(Jacuzzi)obj;
