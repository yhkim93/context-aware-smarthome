...
/**
 *  Java class for concept Microwave of SmartHouseOntology ontology.
 */
public abstract class MicrowaveData	extends Oven implements nuggets.INugget
{
	//-------- constants ----------
	...
	/**
	 *  Get a string representation of this Microwave.
	...
	/**
	 * Persist this Microwave using the nuggets utility.
	 * @param c 
	 */
...
private static final int hash(String name) {
   return ((507572125*name.charAt(0))>>>15)%4;
}
